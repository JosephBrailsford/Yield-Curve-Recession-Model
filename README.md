...
Generates a simple asset allocation recommendation based on where the current probability falls relative to the historical range preceding past recessions
